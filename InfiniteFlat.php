...
class InfiniteFlat implements Plugin{
	...
	public function init(){
		InfiniteFlatSingleGenerator::init();
	...
	protected final static $defaultSettings=array(
...
class InfiniteFlatSingleGenerator implements LevelGenerator{
	...
	public static function init(){
		self::$config=new Config(ServerAPI::request()->api->plugin->configPath(request())."flat generaetor settings.yml", CONFIG_YAML, self::$defaultConfig);
	}
